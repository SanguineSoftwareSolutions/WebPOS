...
//            hmClientDtl.put("080.001", clsClientDetails.createClientDetails("080.001", "PRIMEBIZ HOSPILTALITY LLP",dFormat.parse("2016-01-16"),dFormat.parse("2017-01-16")));
            ...
            hmClientDtl.put("136.001", clsClientDetails.createClientDetails("136.001","KINKI", dFormat.parse("2017-01-05"), dFormat.parse("2019-01-05")));//released on 05-01-2018 for 1 year
            ...
            hmClientDtl.put("189.001", clsClientDetails.createClientDetails("189.001", "CLASSIC BANGLES", dFormat.parse("2017-08-31"), dFormat.parse("2018-01-28"))); // for demo
            ...
            hmClientDtl.put("211.001", clsClientDetails.createClientDetails("211.001", "CHEFS CORNER", dFormat.parse("2017-11-29"), dFormat.parse("2018-01-30")));  // demo
            ...
            hmClientDtl.put("218.001", clsClientDetails.createClientDetails("218.001", "THE LIQUID WISDOM CO.PVT LTD", dFormat.parse("2018-01-15"), dFormat.parse("2018-02-15")));// temporory
            ...
            hmClientDtl.put("223.001", clsClientDetails.createClientDetails("223.001", "BANYAN TREE HOSPITALITY LLP", dFormat.parse("2018-01-17"), dFormat.parse("2018-02-17")));// temporory
            
            hmClientDtl.put("224.001", clsClientDetails.createClientDetails("224.001", "Friendship hospitality Associates", dFormat.parse("2018-01-19"), dFormat.parse("2018-02-19")));// pos name Xo Zero lounge
            
            
            hmClientDtl.put("228.003", clsClientDetails.createClientDetails("228.003","Moti Mahal-MYK Foods and Beverage", dFormat.parse("2018-02-21"), dFormat.parse("2018-05-21")));// HO Call Center
   ...
   /* public static void main(String[] args)
    {
        ...
        for (Map.Entry<String, clsClientDetails> entryOfLicense : hmClientDtl.entrySet())
        {
            ...
            System.out.println(clientCode + "," + objValue.Client_Name + "," + inDate + "," + exDate );
        }
    }*/
}
