...
//		objGlobalFunctionsService.funDeleteWebBookLedgerSummary(clientCode,userCode,propertyCode);
	...
	public Map funGetCommonHashMapForJasperReport(clsWebPOSReportBean objBean, HttpServletRequest req, HttpServletResponse resp)
	{
		Map hm = new HashMap<>();
	...
	public String funGetCurrentDateTime()
    {
        ...
        int hours = objDate.HOUR;
        int minutes = objDate.MINUTE;
        int seconds = objDate.SECOND;
