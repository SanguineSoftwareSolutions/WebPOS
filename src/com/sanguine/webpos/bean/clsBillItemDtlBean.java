...
public class clsBillItemDtlBean
{
   ...
   private int intPaxNo;
    ...
    private List<clsModifiersOnItem> listModifierDtl=new ArrayList<clsModifiersOnItem>();	
    
    private List<clsCustomerDtlsOnBill> listCustomerDtlOnBill=new ArrayList<clsCustomerDtlsOnBill>();
    
    public clsBillItemDtlBean(String strItemCode, String strItemName, double dblQuantity, double dblAmount, double itemSalePrice, boolean isModifier,String customerCode,String customerType,String operationType,String takeAway) {
    ...
    public List<clsModifiersOnItem> getListModifierDtl() {
		return listModifierDtl;
	}

	public void setListModifierDtl(List<clsModifiersOnItem> listModifierDtl) {
	...
	public void setListCustomerDtlOnBill(List<clsCustomerDtlsOnBill> listCustomerDtlOnBill)
	{
