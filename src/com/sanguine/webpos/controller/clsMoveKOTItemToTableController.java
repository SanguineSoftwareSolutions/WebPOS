		        ...
		        List<clsPOSItemDetailFrTaxBean> arrListItemDtl = new ArrayList<clsPOSItemDetailFrTaxBean>();
				 try{
					 ...
					 if(arrListItemDtl.size()>0)
		             {
		                 ...
		                 List<clsTaxCalculationDtls> arrListTaxDtl = objUtilityController.funCalculateTax(arrListItemDtl, loginPosCode, posDate, areaCode, "DineIn", subTotalAmt, 0.0, "Make KOT", "Cash");
