...
//	        }
	    ...
	    private void funGenerateOperatorWiseExcelReport(String posCode, String posName, String fromDate, String toDate)
	    {
	        try
	        {
	            ...
	            List<String> arrListTotal = new ArrayList<String>();
	            List<String> arrHeaderList = new ArrayList<String>();
	            Map<String, List<clsOperatorWiseReportBean>> mapOperatorDtls = new HashMap<String, List<clsOperatorWiseReportBean>>();
	            StringBuilder sbSqlLive = new StringBuilder();
	            StringBuilder sbSqlQFile = new StringBuilder();
	            ...
	            Map<String, Map<String, clsOperatorWiseReportBean>> hmOperatorWiseSales = new HashMap<String, Map<String, clsOperatorWiseReportBean>>();
	            Map<String, clsOperatorWiseReportBean> hmSettlementDtl = null;
	            clsOperatorWiseReportBean objOperatorWiseSales = null;
	            	...
	            	for(int i=0;i<list.size();i++)
	              	{
		              	  ...
		              	  if (hmOperatorWiseSales.containsKey(ob[0].toString()))
		                  {
			                      ...
			                      {
			                          objOperatorWiseSales = new clsOperatorWiseReportBean();
		                  ...
		                  else
		                  {
		                      ...
		                      hmSettlementDtl = new HashMap<String, clsOperatorWiseReportBean>();
		                      hmSettlementDtl.put(ob[7].toString(), objOperatorWiseSales);
		                  }
	            ...
	            for (Map.Entry<String, Map<String, clsOperatorWiseReportBean>> entry : hmOperatorWiseSales.entrySet())
	            {
	                int i = 0;
	                Map<String, clsOperatorWiseReportBean> hmOpSettlementDtl = entry.getValue();
	                for (Map.Entry<String, clsOperatorWiseReportBean> entryOp : hmOpSettlementDtl.entrySet())
	                {
	                    clsOperatorWiseReportBean objOperatorDtl = entryOp.getValue();
