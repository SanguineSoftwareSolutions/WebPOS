...
import com.sanguine.webpos.bean.clsOrderDtlBean;
import com.sanguine.webpos.bean.clsOrderHDBean;
import com.sanguine.webpos.bean.clsWebPOSReportBean;
import com.sanguine.webpos.model.clsOrderHdModel;

@Controller
public class clsCallCenterOrderFlashController
{
	...
	public ModelAndView funOpenForm(Map<String, Object> model, HttpServletRequest request)
	{
		...
		if ("2".equalsIgnoreCase(urlHits))
		{
			...
			return new ModelAndView("frmCallCenterOrderFlash_1", "command", new clsWebPOSReportBean());
		}
		else if ("1".equalsIgnoreCase(urlHits))
		{
			return new ModelAndView("frmCallCenterOrderFlash", "command", new clsWebPOSReportBean());
		}
		else
		{
			return null;
