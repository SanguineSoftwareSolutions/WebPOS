...
public class clsMoveKOTController {
	...
	public ModelAndView funAddUpdate(@ModelAttribute("command") @Valid clsMoveKOTBean objBean,BindingResult result,HttpServletRequest req,@RequestParam("KOTNo") String KOTNo,@RequestParam("tableName") String tableNoTo,@RequestParam("selectedIndx") int selectedIndx)
	{
