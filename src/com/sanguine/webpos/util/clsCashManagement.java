...
public class clsCashManagement {
    ...
    public Map<String,clsCashManagementDtlBean> funGetCashManagement(String fromDate,String toDate, String POSCode) throws Exception
    {
        Map<String,clsCashManagementDtlBean> hmCashMgmtDtl=new HashMap<String,clsCashManagementDtlBean>();
        		...
        		for(int i=0;i<listRollingEntry.size();i++)
		        {
		            ...
		            if(listSalesAmt.size()>0)
		            {
		            	for(int j=0;j<listSalesAmt.size();j++)
				        {
				                 ...
				                 clsCashManagementDtlBean objCashMgmtDtl=new clsCashManagementDtlBean();
    ...
    public double funGetBalanceUserWise(String fromDate,String toDate,Map<String,clsCashManagementDtlBean> hmCashMgmtDtl,String userCode) throws Exception
    {
        double balanceAmt=0;
        if(hmCashMgmtDtl.containsKey(userCode))
        {
            clsCashManagementDtlBean objCashMgmtDtl=hmCashMgmtDtl.get(userCode);
