			...
			<div id="tab1" class="tab_content">
				...
				<div class="row" style="background-color: #fff;display: -webkit-box;">
	    				...
	    				<div class="element-input col-lg-6" style="margin-bottom: 10px;width: 20%;"> 
							<s:input class="large" colspan="3" type="text" id="txtTaxCode" path="strTaxCode"  ondblclick="funHelp('POSTaxMaster')"/>
						</div>
						<div class="element-input col-lg-6" style="width: 15%;" > 
				...
				<div class="row" style="background-color: #fff;display: -webkit-box;">
	    				...
	    				<div class="element-input col-lg-6" style="margin-bottom: 10px;width: 20%;"> 
							<s:input class="large" colspan="3" type="text" id="txtTaxDesc" path="strTaxDesc" />
						</div>
				</div>
				...
				<div class="row" style="background-color: #fff;display: -webkit-box;">
	    				...
	    				<div class="element-input col-lg-6" style="margin-bottom: 10px;width: 20%;"> 
							<s:input class="large" colspan="3" type="text" id="txtTaxShortName" path="strTaxShortName" />
						</div>
						<div class="element-input col-lg-6" style="width: 15%;" > 
	    					<label class="title">Amount</label>
	    				</div>
	    				<div class="element-input col-lg-6" style="margin-bottom: 10px;width: 20%;">
	    					<s:input type="text" id="txtAmount" path="dblAmount" style="text-align: right;" />
						</div>
				</div>
				...
				<div class="row" style="background-color: #fff;display: -webkit-box;">
	    				...
	    				<div class="element-input col-lg-6" style="margin-bottom: 10px;width: 20%;"> 
							<s:input type="text" id="txtPercent" path="dblPercent" style="text-align: right;" />
						</div>
				</div>
				
				<div>
					<table style="background-color:  #2fabe9a1;width: 67%;border: 1px solid;" >
		    				<thead>
									<tr>
										<td style="width:60%;">POS Name</td>
										<td style="width:40%;">Select</td>
									</tr>
							</thead>
					</table>
			   </div>
			   ...
			   <div>
					 <table id="tblPOS" style="background-color:  #d9edf742;width: 67%;border: 1px solid;">
	    				  <tbody>
	    				  		<col style="width:0%">
	    				  		<col style="width:60%">
								<col style="width:40%">
	    		...
	    		<div class="element-input col-lg-6"> 
			    	...
			    	<div Style="width:100%;">
							<table style="background-color:  #2fabe9a1;width: 100%;border: 1px solid;" >
				    				<thead>
											<tr>
												<td style="width:36.5%;">Set Code</td>
												<td style="width:36.5%;">Settlement Name</td>
					  ...
					  <div Style="width:100%;">
							 <table id="tblSettlement" style="background-color:  #d9edf742;width: 100%;border: 1px solid;">
			    				  <tbody>
			    				  		<col style="width:30%">
			    				  		<col style="width:40%">
										<col style="width:40%">
				 ...
				 <div class="element-input col-lg-6" > 
					  ...
					  <div Style="width:100%;">
					   ...
					   <div Style="width:100%;">
							 <table id="tblGroup" style="background-color:  #d9edf742;width: 100%;border: 1px solid;">
			    				  <tbody>
			    				  		<col style="width:30%">
			    				  		<col style="width:40%">
										<col style="width:40%">
...
<!--  Start of Tab3-->
		...
		<div id="tab3" class="tab_content">
		    ...
		    <div class="element-input col-lg-6" > 
				 ...
				 <div Style="width:100%;">
						<table id="tblTax" style="background-color:  #d9edf742;width: 100%;border: 1px solid;">
			    			<tbody>
			...
			<div class="col-lg-10 col-sm-10 col-xs-10" style="width: 70%;">
				<p align="center">
						...
						<div class="submit col-lg-4 col-sm-4 col-xs-4"><input type="button" value="Reset" class="form_button" onclick="funResetFields()"/></div>
				</p>
			</div>
...
<%-- <%-- 						cssClass="searchTextBox" readonly="true" ondblclick="funHelp('POSTaxMaster')" /></td> --%> --%>
