		...
		<div class="title" style="margin-left: 190px;">
			<div class="row" style="background-color: #fff;">
    			...
    			<div class="element-input col-lg-6" style="margin-bottom:  10px;"> 
					<s:input type="text" id="txtAdvOrderCode" path="strAdvOrderCode"  ondblclick="funHelp('POSAdvOrderMaster')" cssClass="searchBox"/>
				</div>
			 </div>
			 <div class="row" style="background-color: #fff;">
				<div class="element-input col-lg-6" > 
    			...
    			<div class="element-input col-lg-6" style="margin-bottom:  10px;"> 
					<s:input class="large" colspan="3" type="text" id="txtAdvOrderName" path="strAdvOrderName" />
				</div>
			 </div>
			  <div class="row" style="background-color: #fff;">
				...
				<div class="element-input col-lg-6" style="width: 45%;margin-bottom: 30px;">
					<s:select id="cmbOperational" path="strOperational" style="height: 10%; margin-left: -16px; width: 113%;">
...
<!-- 		</p> -->
		...
		<div class="col-lg-10 col-sm-10 col-xs-10" style="width: 50%;margin-left: 240px;">
     			<p align="center">
            		<div class="submit col-lg-4 col-sm-4 col-xs-4"><input type="submit" value="Submit" style="width: 90%;"/></div>
          
            		<div class="submit col-lg-4 col-sm-4 col-xs-4"><input type="reset" value="Reset" onclick="funResetFields()" style="width: 90%;"></div>
     			</p>
   		</div>
	</s:form>
