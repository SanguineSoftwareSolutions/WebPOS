		...
		<div class="title">
			...
			<div class="row" style="background-color: #fff;">
    			...
    			<div class="element-input col-lg-6" style="margin-bottom: 10px;" > 
					<s:input class="large" colspan="3" type="text" id="txtSubGroupCode" path="strSubGroupCode"  ondblclick="funHelp('POSSubGroupMaster')"/>
				</div>
			 </div>
			 ...
			 <div class="row" style="background-color: #fff;">
    			...
    			<div class="element-input col-lg-6" style="margin-bottom: 10px;" > 
					<s:input class="large" colspan="3" type="text" id="txtSubGroupName" path="strSubGroupName" />
				</div>
			 </div>
			 ...
			 <div class="row" style="background-color: #fff;">
    			...
    			<div class="element-input col-lg-6" style="margin-bottom: 10px;" > 
					<s:select id="cmbGroupCode" path="strGroupCode" >
					</s:select>
				</div>
			 </div>
			 ...
			 <div class="row" style="background-color: #fff;">
    			...
    			<div class="element-input col-lg-6" style="margin-bottom: 10px;" > 
					<s:input class="large" colspan="3" type="text" id="txtIncentives" path="strIncentives" />
				</div>
			 </div>
