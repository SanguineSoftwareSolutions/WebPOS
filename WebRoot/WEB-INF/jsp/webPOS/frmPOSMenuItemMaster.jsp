...
<br/>
	...
	<div class="title">
			...
			<div class="row" style="background-color: #fff; display: -webkit-box;">
				<div class="element-input col-lg-6" style="width: 33%;"> 
			...
			<div class="row" style="background-color: #fff; display: -webkit-box;">
			 	...
			 	<div class="row" style="background-color: #fff; display: -webkit-box;">
    				...
    				<div class="element-input col-lg-6" style="margin-bottom: 10px;">
    					 <s:input id="txtSalePrice" path="dblSalePrice" type="number" min="0" step="1" style="text-align: right;" />
			 		</div>
			 	</div>
			 	...
			 	<div class="row" style="background-color: #fff; display: -webkit-box;">
	    			...
	    			<div class="element-input col-lg-6" style="width: 25%;">
	    				<s:input  id="txtMaxLevel" path="dblMaxLevel" type="number" min="0" step="1" style="text-align: right;" />
					</div>
					<div class="element-input col-lg-6" style="width: 25%;">
			   ...
			   <div class="row" style="background-color: #fff; display: -webkit-box;">
					<div class="element-input col-lg-6" > 
    					<label class="title">Unit Of Measurement</label>
    				</div>
    				<div class="element-input col-lg-6" style="margin-bottom: 10px;"> 
    				...
    				<div class="element-input col-lg-6"> 
						<s:textarea id="txtItemDetails" path="strItemDetails" name="textarea" style="min-width: 180px; min-height: 50px;"/>
					</div>
				</div>
	</div>
