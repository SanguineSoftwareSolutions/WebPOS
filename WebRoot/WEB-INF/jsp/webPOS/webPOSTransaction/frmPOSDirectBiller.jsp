					...
					<tr>
							...
							<div id="divDineInDetail" style="border: 1px solid rgb(204, 204, 204);height: 56px;overflow: auto;width: 380px;display: block;" >																	
									<table id="tblDineInDetail"   style="border-collapse: separate;">
										<tbody>
											...
											<tr>
												<td style="width: 150px;"><label class="btn  btn-link">TABLE</label></td>
												<td style="width: 150px;"><label class="btn-link">WATER</label></td>
												<td style="width: 50px;"><label class="btn-link">PAX</label></td>
												<td style="width: 100px;"><label class="">KOT NO</label></td>
											</tr>
										</tbody>
									</table>
							</div>
							...
							<div id="divBillItemDtl" style="border: 1px solid rgb(204, 204, 204);height: 548px;overflow: auto;width: 380px;display: block;padding: 0px;margin-top: 2px;margin-bottom: 2px;">
								...
								<table id="tblBillItemDtl"   style="border-collapse: separate;" ><!-- class="transTablex" -->
									<tr>
										  ...
										  <th><input type="button" value="Amount" styl
										  e="width: 62px;" class="tblBillItemDtlColBtnGrp btn "  ></input></th>
						...
						<td>
							<div id="divArea" style="border: 1px solid rgb(204, 204, 204);height: 56px;overflow: auto;width: 650px;display: block;" >																	
									<table id="tblArea"   style="border-collapse: separate;">
				...
				<!-- <div id="divBottomButtonsNavigator" style="border: 1px solid #ccc; height: 40px;  overflow-x: auto; overflow-y:; width: 615px; "> -->
				 	<table id="tblFooterButtons"   style="border-collapse: separate;" > <!-- class="table table-striped table-bordered table-hover" -->				 																																	
							<tr>							
								...
								<td style="padding-right: 5px;"><input type="button"  id="Home" value="BACK"    style="width: 100px;height: 50px; white-space: normal;"   onclick="funFooterButtonClicked(this)" class="btn btn-success"/></td>
								<td style="padding-right: 5px;"><input type="button"  id="Delivery Boy" value="Delivery Boy"    style="width: 100px;height: 50px; white-space: normal;"   onclick="funFooterButtonClicked(this)" class="btn btn-success"/></td>
								<td style="padding-right: 5px;"><input type="button"  id="Done" value="Done"    style="width: 100px;height: 50px; white-space: normal;"   onclick="funFooterButtonClicked(this)" class="btn btn-success"/></td>
