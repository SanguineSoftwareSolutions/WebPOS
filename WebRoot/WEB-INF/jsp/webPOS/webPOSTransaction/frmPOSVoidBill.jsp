...
<!-- 							</tr> -->
	       ...
	       <div style=" width: 50%; height: 450px;float:right;  overflow-x: hidden; border-collapse: separate; overflow-y: scroll;">
				...
				<div style="border: 1px solid #ccc; display: block; height: 400px; margin: auto; overflow-x: scroll; overflow-y: scroll; width: 90%;">
