...
<br/>
	...
	<s:form name="POSTableMaster" method="POST" action="savePOSTableMaster.html?saddr=${urlHits}" class="formoid-default-skyblue" style="background-color:#FFFFFF;font-size:14px;font-family:'Open Sans','Helvetica Neue','Helvetica',Arial,Verdana,sans-serif;color:#666666;max-width:880px;min-width:150px;margin-top:2%;">
		...
		<div id="tab_container" style="height: 505px; overflow: hidden;" >
				<ul class="tabs">
							<li class="active" data-state="tab1" style="width: 15%; padding-left: 3%; height: 25px; border-radius: 4px;">Table Master</li>
							<li data-state="tab2" style="width: 15%; padding-left: 3%; height: 25px; border-radius: 4px;">Table Sequence</li>
				</ul>
	...
	<!--  Start of tab2-->
		...
		<div id="tab2" class="tab_content">
			...
			<br />
			 ...
			 <div class="col-lg-10 col-sm-10 col-xs-10" style="width: 70%;">
				 <p align="center">
					 <div class="submit col-lg-4 col-sm-4 col-xs-4"><input type="submit" id="tblSequence" value="Submit" tabindex="3" class="form_button" /></div>
				 </p>
		     </div>
