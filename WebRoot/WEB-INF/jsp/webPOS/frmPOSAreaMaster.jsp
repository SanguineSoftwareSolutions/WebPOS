	...
	<s:form name="AreaForm" method="POST" action="savePOSAreaMaster.html"  class="formoid-default-skyblue" style="background-color:#FFFFFF;font-size:14px;font-family:'Open Sans','Helvetica Neue','Helvetica',Arial,Verdana,sans-serif;color:#666666;max-width:880px;min-width:150px;margin-top:2%;" > 
	 ...
	 <div class="title" style="margin-left: 190px;">
			<div class="element-input col-lg-6" style="width:30%;" > 
				...
				<s:input class="large" colspan="3" type="text" id="txtAreaCode" path="strAreaCode"  ondblclick="funHelp('POSAreaMaster')"/>
			</div>
			<div class="element-input col-lg-6" >
				<label class="title">Area Name</label>
				<s:input class="large" colspan="3" type="text" id="txtAreaName" path="strAreaName" style="width:55%"  />
			</div> 
			
			<div class="element-select col-lg-12" style="width: 93%;">
					<label class="title">POS Name</label>
					<div class="large">
						<s:select id="cmbPOSName" path="strPOSName" items="${posList}"  style="height: 10%; width: 30%;"/>
					</div>
			</div>
