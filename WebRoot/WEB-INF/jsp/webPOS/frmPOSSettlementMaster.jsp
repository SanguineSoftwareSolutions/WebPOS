...
<br/>
	...
	<div id="tab_container" style="height: 505px; overflow: hidden;" >
					<ul class="tabs">
								<li class="active" data-state="tab1" style="width: 12%; padding-left: 3%; height: 25px; border-radius: 4px;">General</li>
								<li data-state="tab2" style="width: 12%; padding-left: 2%; height: 25px; border-radius: 4px;">Linkup</li>
					</ul>
							<br /> <br />
