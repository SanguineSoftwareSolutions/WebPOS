		...
		<div class="title">
			...
			<div class="row" style="background-color: #fff;">
    			...
    			<div class="element-input col-lg-6" style="margin-bottom: 10px;" > 
					<s:input class="large" colspan="3" type="text" id="txtReasonCode" path="strReasonCode"  ondblclick="funHelp('POSReasonMaster')"/>
				</div>
			 </div>
			 ...
			 <div class="row" style="background-color: #fff;">
    			...
    			<div class="element-input col-lg-6" style="margin-bottom: 10px;" > 
					<s:input class="large" colspan="3" type="text" id="txtReasonName" path="strReasonName" />
				</div>
			 </div>
			 
			 <div class="row" style="background-color: #fff;display: -webkit-box;">
				<div class="element-input col-lg-6" style="width: 18%;margin-left: 14px;" > 
			 ...
			 <div class="row" style="background-color: #fff;display: -webkit-box;margin-bottom: 10px;">
    			...
    			<div class="element-input col-lg-6" style="width:100%;">
    				 <s:input type="checkbox"  id="chkCashManagement" path="strCashMgmt"  style="width: 2%"></s:input>Cash Management
				     <s:input type="checkbox"  id="chkUnsettleBill" path="strUnsettleBill" style="width: 2%" ></s:input>Unsettle Bill
			 ...
			 <div class="row" style="background-color: #b9def800;">
			 	<div class="element-input col-lg-6" style="width: 55%;">
			 		<label class="title">Transfer Type</label>
			 	</div>
				<div class="element-input col-lg-6" style="width: 45%;margin-bottom: 30px;">
					<s:select id="cmbTransferType" path="strTransferType" style="height: 10%;width: 113%;">
			...
			<div class="row" style="background-color: #b9def800;">
				...
				<div class="element-input col-lg-6" style="width: 45%;margin-bottom: 30px;">
					<s:select id="cmbTransferEntry" path="strTransferEntry" style="height: 10%;width: 113%;">
							<option value="Other">Other</option>
					</s:select>
				</div>	
			</div>
