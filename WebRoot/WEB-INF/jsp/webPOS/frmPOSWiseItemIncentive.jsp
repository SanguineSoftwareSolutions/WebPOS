	...
	**/
  	...
  	function funFillTableCol(item0,item1,item2,item3,item4)
	{
		...
		if(item2=="Amt" || item2=="amt")
	      ...
	      row.insertCell(0).innerHTML= "<input    readonly=\"readonly\" class=\"Box \" size=\"34%\" name=\"listItemIncentive["+(rowCount)+"].strItemCode\" id=\"txtDate."+(rowCount)+"\" value='"+item0+"' />"; 
	      row.insertCell(1).innerHTML= "<input  readonly=\"readonly\" class=\"Box \" size=\"40%\" name=\"listItemIncentive["+(rowCount)+"].strItemName\" id=\"txtDate."+(rowCount)+"\" value='"+item1+"' />";
	      row.insertCell(2).innerHTML= "<input readonly=\"readonly\" class=\"Box \" size=\"7%\"><select  readonly=\"readonly\" class=\"Box \" style=\"width: 55%;margin-left: 15px;\" name=\"listItemIncentive["+(rowCount)+"].strIncentiveType\"  id=\"txtCompStk\" value='"+item2+"'onclick=\"creatBrandOptions(this)\"> <OPTION>"+item2 +"</OPTION><OPTION>"+comboitem+"</OPTION></SELECT>";
	      row.insertCell(3).innerHTML= "<input style=\"text-align: right;\" size=\"30%\" class=\"Box \" name=\"listItemIncentive["+(rowCount)+"].strIncentiveValue\" id=\"txtPhyStk."+(rowCount)+"\" value='"+item3+"' />";
			 ...
			 <div class="container" style="background-color: #fff; width: 100%;">
					 	<div class="col-xs-4" style="margin-left: -30%; width: 100%;">
			      	 		<div id="tableLoad" style="margin-left: -12px;">	
								...
								<table class="scroll" style="width:97%;" >
			    					<thead>
			        					<tr> 
			    				...
			    				<table class="scroll" id="tblListData" style="width: 97%;">
			    					<tbody>				
