...
<div id="formHeading">
	...
	<s:form name="WaiterWiseItemReport" method="POST" action="rptWaiterWiseItemReport.html?saddr=${urlHits}" target="_blank">
		<br />
		<br />
		<table class="masterTable">
			...
			<tr>
				...
				<tr>
					<td>&emsp;&ensp;&emsp;&ensp;
					<label>Waiter Name</label></td>
					<td >
						<s:select id="cmbSelectType" path="strWShortName" cssClass="BoxW124px" items="${waiterlist}">
