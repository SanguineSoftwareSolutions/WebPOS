...
<body> 
	...
	<div style="width: 57%; overflow: scroll;margin-left: 10%;">
...
<!-- All Tables End Here -->
		 ...
		 <td colspan="4">
			<div id="tableImg" style="width: 100%; height: 120px; overflow-x: scroll; overflow-y: hidden;">
			<table class="transTablex"><!-- style="height:120px; border: #0F0;width: 100%;font-size:11px;overflow-x: scroll; font-weight: bold;"> -->	    
			 <tr bgcolor="#72BEFC">
